const moreArticles = [
  ...
  },
  {
    id: 69514,
    title:
      'Maserati銷量大幅成長、加速電氣轉型，Stellantis集團於2021年交出亮眼成績',
    summary:
      '作為一家2021年1月17日才成立、旗下擁有14個汽車品牌的全新集團，Stellantis 於昨日 (2/23) 公佈2021年創紀錄的財報，並再次宣布集團在未來10年的電動車轉型計畫，不只將在2年內推出21款電動車，且宣佈他們將與鴻海科技在電池技術、電池材料和軟件開發方面，建立強大的合作夥伴關係。',
    category: 1,
    date: '2022/02/24',
  },
  {
